...
import cardImage4 from '@/assets/card-img-4.png'
...
const cardsContent = [
  ...
  },
  {
    ...
    description: 'Accelerate fleet electrification with Autel and step into the future of intelligent fleet management and energy management. Vehicle ready tailored to you needs. From initial planning to site maintenance, Autel ensures all-stage hassle-free charging experience and service for fleet owners.',
    link: ''
  },
  {
    image: cardImage3,
...
<template>
  <SectionWrapper title="Solution.">
    <div class="flex flex-col gap-4">
      ...
      <Card v-for="(card, index) in cardsContent" :key="index" :card-content="card" :isOdd="index % 2 === 0" />
    </div>
